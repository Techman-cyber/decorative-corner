...
document.getElementById('product-name').textContent=name;document.getElementById('product-image').src=p.image;document.getElementById('product-price').textContent=p.price?'₹'+p.price:'₹125';document.getElementById('product-description').textContent=p.description;
